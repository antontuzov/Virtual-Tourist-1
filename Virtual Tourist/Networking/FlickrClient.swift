...
class FlickrClient {
    ...
    class func getSearchURL(lat: Double, long: Double, totalPageNum: Int = 0, pageNum: Int,completion: @escaping ([PhotoStruct], Error?) -> Void){
        
        let url = Endpoints.searchURL(lat, long, totalPageNum, pageNum).url
